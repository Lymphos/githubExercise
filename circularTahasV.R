...
plot.circular(myParam.circ, col = colorGraph, cex = 0.72, pch = 16,
...
if(circMeanArrowBool){arrows.circular(myParam.circ.mean, length = 0.1, lwd = 2, col = colorGraph, shrink = 0.65)}
